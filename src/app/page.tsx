    ...
    <div className="w-screen min-h-svh flex flex-col items-center bg-gradient-to-b from-black to-[#161616]">
      <main className="w-full max-w-4xl flex flex-col items-center border-x border-white/10 flex-1">
        ...
        <div className="flex flex-col w-full items-center p-8 gap-5 flex-1">
          <h1 className="text-[123px] text-center leading-[82%] font-bold font-kode-mono uppercase tracking-tight text-white/80">Somnia Get ready for <span className="text-red font-kode-mono">SURPLS</span></h1>
